...
public class EqualsOrGreaterThanValidator implements Rule<Object> {

    private final String field;
    private final Number minValue;

    public EqualsOrGreaterThanValidator(String field, Number minValue) {
        this.field = field;
    ...
    public void validate(final Object value, final ValidationContext context) {
        ...
        if (number.doubleValue() < minValue.doubleValue()) {
            context.addError("The field '" + field + "' must to be equals or greater than " + minValue + ".");
        }
    }
